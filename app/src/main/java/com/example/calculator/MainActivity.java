...
public class MainActivity extends AppCompatActivity {
    ...
    public void equalsClick(View view) {
        ...
        userExpression = userExpression.replaceAll(regex: "x", replacement: "*");
        userExpression = userExpression.replaceAll(regex: "÷", replacement: "/");
        ...
        calculatorText.setSelection(cursorPostion - 1);
    }
    ...
    public void onBackspaceClick(View view) {
        ...
        if(cursorPosition != 0 && textLength != 0) {
            ...
            selection.replace(start cursorPosition - 1, cursorPosition, tb: "");
